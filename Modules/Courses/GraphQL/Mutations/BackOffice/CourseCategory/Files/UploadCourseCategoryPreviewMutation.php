...
class UploadCourseCategoryPreviewMutation extends BaseMutation
{
    public const NAME = 'uploadCourseCategoryPreview';

    public const DESCRIPTION = 'Upload course category preview. Returns url of uploaded file.';
    ...
    {
        return $this->coursesService->updatePreviewImage($args['id'], $args['file']);
    }
}
