...
use Modules\Core\GraphQL\Schemas\CoreBackOfficeSchema;
use Modules\Core\GraphQL\Schemas\CoreDefaultSchema;
...
return [
    ...
    'schemas' => [
        'default' => CoreDefaultSchema::class,
        'BackOffice' => CoreBackOfficeSchema::class,
    ],
